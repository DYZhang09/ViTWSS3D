        ...
        for batch_id in range(len(result)):
            ...
            if 'gt_bboxes_3d' in data.keys():
                if isinstance(data['gt_bboxes_3d'][0], DC):
                    gt_bboxes_3d = data['gt_bboxes_3d'][0]._data[0][batch_id].tensor.numpy()
                elif mmcv.is_list_of(data['gt_bboxes_3d'][0], BaseInstance3DBoxes):
                    gt_bboxes_3d = data['gt_bboxes_3d'][0][batch_id].tensor
                else:
            ...
            if (box_mode_3d == Box3DMode.CAM) or (box_mode_3d
                ...
                if gt_bboxes_3d is not None:
                    gt_bboxes_3d = Box3DMode.convert(gt_bboxes_3d, box_mode_3d, Box3DMode.DEPTH)
