...
parser.add_argument('--convert_format', type=bool, default=True)
parser.add_argument('--create_infos', type=bool, default=True)
parser.add_argument('--create_gt_database', type=bool, default=True)
...
if __name__ == '__main__':
    if args.dataset == 'kitti':
        ...
        waymo_data_prep(
            ...
            create_infos=args.create_infos,
